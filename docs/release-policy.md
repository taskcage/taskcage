...
|---|---|---|---|
| TaskCage daemon | `taskcaged-v0.4.0` | `daemon/Cargo.toml` | GitHub Release |
| Java SDK | `java-sdk-v0.3.0` | `java-sdk/build.gradle.kts` | Maven Central, GitHub Release |
...
```text
taskcaged 0.1.0   ─┐
taskcaged 0.4.0   ─┼─ Local Protocol v1, v2; Remote Protocol v1
Java SDK 0.3.0    ─┘
```
