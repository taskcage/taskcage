# TaskCage documentation authority

The repository root [`README.md`](../README.md) is the final product decision
and source of truth for the contest MVP.

Active documents elaborate that decision:
...
historical and are never implementation authority.
