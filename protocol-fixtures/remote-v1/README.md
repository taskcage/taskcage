...
- `submit-profile-valid.json`, `profile-accepted.json`, `submit-profile-idempotent-retry.json`: managed input
  Artifact를 이용한 Profile 수락, task-owned input의 같은 `clientRequestId` 재시도
